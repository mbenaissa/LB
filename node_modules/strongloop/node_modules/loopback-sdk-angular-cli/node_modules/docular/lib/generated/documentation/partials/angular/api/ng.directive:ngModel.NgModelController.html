<h1><code ng:non-bindable="">ngModel [NgModelController] </code>
<span class="hint">( type in module <code ng:non-bindable="">ng</code>
 )</span>
</h1>
<div><h2 id="Description">Description</h2>
<div class="description"> <code class="plain">NgModelController</code>  provides API for the  <code class="plain">ng-model</code>  directive. The controller contains
services for data-binding, validation, CSS update, value formatting and parsing. It
specifically does not contain any logic which deals with DOM rendering or listening to
DOM events. The  <code class="plain">NgModelController</code>  is meant to be extended by other directives where, the
directive provides DOM manipulation and the  <code class="plain">NgModelController</code>  provides the data-binding.</p>

<p>This example shows how to use  <code class="plain">NgModelController</code>  with a custom control to achieve
data-binding. Notice how different directives ( <code class="plain">contenteditable</code> ,  <code class="plain">ng-model</code> , and  <code class="plain">required</code> )
collaborate together to achieve the desired result.</p>

<h4>Source</h4>
<div source-edit="customControl" source-edit-deps="angular.js script.js" source-edit-html="index.html-122" source-edit-css="style.css-120" source-edit-js="script.js-121" source-edit-unit="" source-edit-scenario="scenario.js-123"></div>
<div class="tabbable"><div class="tab-pane" title="index.html">
<pre class="prettyprint linenums" ng-set-text="index.html-122" ng-html-wrap="customControl angular.js script.js"></pre>
...
<pre class="prettyprint linenums" ng-set-text="style.css-120"></pre>
<style type="text/css" id="style.css-120">
      [contenteditable] {
...
<div class="well doc-example-live" ng-embed-app="customControl" ng-set-html="index.html-122" ng-eval-javascript="script.js-121"></div></div>
...
<ul class="parameters"><li><code class="plain">validationErrorKey – {string} – </code>
<p>Name of the validator. the  <code class="plain">validationErrorKey</code>  will assign
to  <code class="plain">$error[validationErrorKey]=isValid</code>  so that it is available for data-binding.
The  <code class="plain">validationErrorKey</code>  should be in camelCase and will get converted into dash-case
for class name. Example:  <code class="plain">myError</code>  will result in  <code class="plain">ng-valid-my-error</code>  and  <code class="plain">ng-invalid-my-error</code> 
class and can be bound to as   <code class="plain">{{someForm.someControl.$error.myError}}</code>  .</p></li>
<li><code class="plain">isValid – {boolean} – </code>
...
For example <a href="documentation/angular/api/ng.directive:input"><code>input</code></a> or
<a href="documentation/angular/api/ng.directive:select"><code>select</code></a> directives call it.</p>

<p>It internally calls all  <code class="plain">formatters</code>  and if resulted value is valid, updates the model and
calls all registered change listeners.</p><h4 id="Parameters">Parameters</h4>
<ul class="parameters"><li><code class="plain">value – {string} – </code>
