...
<div class="usage">as attribute<pre class="prettyprint linenums">&lt;input ng-list="{string}"&gt;
   ...
&lt;/input&gt;</pre>
as class<pre class="prettyprint linenums">&lt;input class="ng-list: {string};"&gt;
   ...
&lt;/input&gt;</pre>
<h3 id="Parameters">Parameters</h3>
<ul class="parameters"><li><code class="plain">ngList<i>(optional)</i> – {string=} – </code>
<p>optional delimiter that should be used to split the value. If
specified in form  <code class="plain">/something/</code>  then the value will be converted into a regular expression.</p></li>
</ul>
</div>
