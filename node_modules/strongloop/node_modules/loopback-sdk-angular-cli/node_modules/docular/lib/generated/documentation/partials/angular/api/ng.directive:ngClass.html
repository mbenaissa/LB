...
<div class="description"><p>The  <code class="plain">ngClass</code>  allows you to set CSS class on HTML element dynamically by databinding an
...
<ul class="parameters"><li><code class="plain">ngClass – {expression} – </code>
...
<div source-edit="" source-edit-deps="angular.js" source-edit-html="index.html-90" source-edit-css="style.css-91" source-edit-js="" source-edit-unit="" source-edit-scenario="scenario.js-92"></div>
...
<pre class="prettyprint linenums" ng-set-text="style.css-91"></pre>
<style type="text/css" id="style.css-91">
  .my-class {
    color: red;
  }
</style>
...
<pre class="prettyprint linenums" ng-set-text="scenario.js-92"></pre>
<script type="text/ng-template" id="scenario.js-92">
