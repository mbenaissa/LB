...
.responsive-design-toolbar {
    ...
    -webkit-flex: none;
        -ms-flex: none;
            flex: none;
    background: -webkit-linear-gradient(top, rgb(64, 64, 64), rgb(58, 58, 58));
...
.responsive-design-section-device .responsive-design-section-separator {
    background: -webkit-linear-gradient(top, rgb(255, 186, 68), rgb(255, 119, 0));
...
.responsive-design-section-network .responsive-design-section-separator {
    background: -webkit-linear-gradient(top, rgb(77, 170, 243), rgb(0, 130, 255));
...
/*# sourceMappingURL=responsiveDesignView.css.map */