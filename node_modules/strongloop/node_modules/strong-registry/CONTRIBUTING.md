...
Thank you for your interest in `strong-registry`, an open source project
administered by StrongLoop.

Contributing to `strong-registry` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/strong-registry)
