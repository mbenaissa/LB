...
Thank you for your interest in `strong-statsd`, an open source project
administered by StrongLoop.

Contributing to `strong-statsd` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/strong-statsd)
