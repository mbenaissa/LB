...
var debuglog = require('debug')('strong-statsd:backend:graphite');
var net = require('net');
  ...
  if (graphiteHost) {
    try {
      ...
      graphite.addListener('error', function(connectionException){
        debuglog('connection error:', connectionException);
        if (debug) {
      ...
      // XXX(SR) This is upstream code, and its broken, connect doesn't throw,
      // and in the .on(error) above, it doesn't set the last_exception!
      if (debug) {
        l.log(e);
      }
