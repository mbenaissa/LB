...
Thank you for your interest in `strong-wait-till-listening`, an open source project
administered by StrongLoop.

Contributing to `strong-wait-till-listening` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/strong-wait-till-listening)
