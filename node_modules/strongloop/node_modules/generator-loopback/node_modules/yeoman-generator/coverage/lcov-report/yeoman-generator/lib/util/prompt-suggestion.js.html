...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/util/prompt-suggestion.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/util/prompt-suggestion.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.59% <small>(65 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">88.57% <small>(31 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/util/</a> &#187; prompt-suggestion.js</div>
</div>
<div class="body">
...
var storeListAnswer = function (question, answer) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (question.default !== choiceIndex) {
    return true;
  }
...
var storeAnswer = function (question, answer) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (answer &amp;&amp; question.default !== answer) {
    return true;
  }
<span class="cstat-no" title="statement not covered" >  return false;</span>
};
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (storedValue == null) <span class="cstat-no" title="statement not covered" >return question;</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (saveAnswer) {
