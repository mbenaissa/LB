...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/actions/actions.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/actions/actions.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.02% <small>(80 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">93.02% <small>(80 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/actions/</a> &#187; actions.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2042</span>
<span class="cline-any cline-yes">2042</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2042</span>
...
<span class="cline-any cline-yes">2042</span>
<span class="cline-any cline-yes">2042</span>
<span class="cline-any cline-yes">2041</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2042</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2019</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2019</span>
<span class="cline-any cline-yes">2019</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11</span>
<span class="cline-any cline-yes">2023</span>
<span class="cline-any cline-yes">2023</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof destination === 'function') {
<span class="cstat-no" title="statement not covered" >    process = destination;</span>
<span class="cstat-no" title="statement not covered" >    destination = source;</span>
  }
&nbsp;
  source = this.isPathAbsolute(source) ? source : path.join(this.sourceRoot(), source);
  destination = this.isPathAbsolute(destination) ? <span class="branch-0 cbranch-no" title="branch not covered" >destination </span>: path.join(this.destinationRoot(), destination);
&nbsp;
  var encoding = null;
...
<span class="cstat-no" title="statement not covered" >    this.log.error('Error setting permissions of "' + chalk.bold(file.destination) + '" file: ' + err);</span>
  }
&nbsp;
...
actions.template = function template(source, destination, data, options) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!destination || !this.isPathAbsolute(destination)) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.isPathAbsolute(source)) {
    source = path.join(
      this.sourceRoot(),
...
actions.engine = function engine(body, data, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._engine) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Trying to render template without valid engine.');</span>
  }
&nbsp;
...
actions.bulkDirectory = function directory(source, destination, process) {
  ...
  this.conflicter.checkForCollision(destination, null, function (err, status) {
    ...
    // actual write.
    <span class="missing-if-branch" title="else path not taken" >E</span>if (/force|create/.test(status)) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jan 02 2015 15:35:01 GMT-0500 (EST)</div>
</div>
