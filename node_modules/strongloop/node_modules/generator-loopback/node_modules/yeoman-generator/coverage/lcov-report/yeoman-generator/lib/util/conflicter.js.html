...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/util/conflicter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/util/conflicter.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">92.45% <small>(49 / 53)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/util/</a> &#187; conflicter.js</div>
</div>
<div class="body">
...
Conflicter.prototype.resolve = function (cb) {
  ...
  var resolveConflicts = function (conflict) {
    return function (next) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!conflict) <span class="cstat-no" title="statement not covered" >return next();</span>
&nbsp;
...
&nbsp;
  this.adapter.prompt([prompt], function (result) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (result.action === 'abort') {
<span class="cstat-no" title="statement not covered" >      this.adapter.log.writeln('Aborting ...');</span>
<span class="cstat-no" title="statement not covered" >      return process.exit(0);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (result.action === 'diff') {
<span class="cstat-no" title="statement not covered" >      this.adapter.diff(fs.readFileSync(file.path, 'utf8'), file.contents);</span>
<span class="cstat-no" title="statement not covered" >      return this._ask(file, cb);</span>
    }
&nbsp;
