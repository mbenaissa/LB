...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/actions/install.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/actions/install.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.62% <small>(44 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">77.78% <small>(21 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/actions/</a> &#187; install.js</div>
</div>
<div class="body">
...
install.runInstall = function (installer, paths, options, cb) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!cb &amp;&amp; _.isFunction(options)) {
  ...
  this.env.runLoop.add('install', function (done) {
    ...
    this.spawnCommand(installer, args, options)
      ...
      .on('exit', function (err) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err === 127) {
<span class="cstat-no" title="statement not covered" >          this.log.error('Could not find ' + installer + '. Please install with ' +</span>
...
&nbsp;
  options = _.defaults(options || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> {
    bower: true,
    npm: true,
    skipInstall: false,
    skipMessage: false,
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options.bower) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options.npm) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.skipMessage) {
