...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/actions/remote.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/actions/remote.js</span></h1>
    <h2>
        
        Statements: <span class="metric">89.87% <small>(71 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">89.87% <small>(71 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/actions/</a> &#187; remote.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      self.extract(url, cache, { strip: 1 }, done);</span>
    }
  });
&nbsp;
  return this;
...
&nbsp;
  ...
  remoteFs.template = <span class="fstat-no" title="function not covered" >function template(source, destination, data) {</span>
<span class="cstat-no" title="statement not covered" >    data = data || self;</span>
<span class="cstat-no" title="statement not covered" >    destination = destination || source;</span>
<span class="cstat-no" title="statement not covered" >    source = path.join(cache, source);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var body = self.engine(self.read(source), data);</span>
<span class="cstat-no" title="statement not covered" >    self.write(destination, body);</span>
  };
&nbsp;
...
&nbsp;
  remoteFs.dest.registerValidationFilter('collision', self.getCollisionFilter());
  remoteFs.src.registerValidationFilter('collision', self.getCollisionFilter());
&nbsp;
