...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/actions/wiring.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/actions/wiring.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.84% <small>(85 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">98.84% <small>(85 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/actions/</a> &#187; wiring.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (content !== undefined) {
    if (mode === 'a') {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (mode === 'd') {
      $(tagName).remove();
    }
    return $.html();
  } else {
<span class="cstat-no" title="statement not covered" >    console.error('Please supply valid content to be updated.');</span>
  }
};
&nbsp;
/**
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (fileType === 'css') {
    sourceFileList.forEach(function (el) {
